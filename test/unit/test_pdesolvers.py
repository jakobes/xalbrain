...
class TestMonodomainSolver(object):
    ...
    @fast
    def test_compare_lumped_direct(self):
        "Test that direct and iterative solution give comparable results."
        self.setUp()
        ...
        print "mass lumping: 0.",  a
        print "mass lumping: 0.5", b
        print "mass lumping: 1.0", c
        assert_almost_equal(a, b, 1e-4)
        assert_almost_equal(a, c, 1e-4)
