...
class Tentusscher_2004_mcell(CellModel):
    """
NOT_IMPLEMENTED
    """
    ...
    def _I(self, v, s, time):
        ...
        i_Stim = -stim_amplitude*(1 - 1/(1 + ufl.exp(5.0*time -\
            ...
            5.0*stim_duration))
        current[0] = -i_Ks - i_NaCa - i_CaL - i_b_Na - i_Kr - i_p_Ca - i_to -\
            i_b_Ca - i_Stim - i_Na - i_p_K - i_NaK - i_K1
    ...
    def F(self, v, s, time=None):
        ...
        alpha_xs = 1100.0/ufl.sqrt(1 +\
            0.188875602838*ufl.exp(-0.166666666667*V))
        ...
        beta_m = 0.1/(1 + ufl.exp(7 + V/5)) + 0.1/(1 +\
            0.778800783071*ufl.exp(0.005*V))
        ...
        tau_f = 80 + 165.0/(1 + ufl.exp(5/2 - V/10)) +\
        ...
        F_expressions[8] = (1 - 1.0/((1 + ufl.exp(60 + V))*(1 +\
            ufl.exp(10.0*fCa_inf - 10.0*fCa))))*d_fCa
        ...
        tau_s = 3 + 5/(1 + ufl.exp(-4 + V/5)) + 85*ufl.exp(-0.003125*((45 +\
            V)*(45 + V)))
