...
#ifndef __ADEXPOINTINTEGRALSOLVER_H
#define __ADEXPOINTINTEGRALSOLVER_H
...
namespace dolfin
{
  ...
  class AdexPointIntegralSolver : public Variable
  {
  public:
    ...
    /// Parameters
    explicit AdexPointIntegralSolver(std::shared_ptr<MultiStageScheme> scheme);

    /// Destructor
    ~AdexPointIntegralSolver();
  ...
  private:
    ...
    void _apply_condition(std::vector<double> *);
